package vaycent.vaycentproject.DemoPackage.SmsPackage;
...
public class SmsDemo extends AppCompatActivity implements View.OnClickListener{
...
//                System.out.println("read:"+read);
    ...
    public Handler smsHandler = new Handler() {public void handleMessage(android.os.Message msg) {
    ...
    private Dialog showProgressDialog() {
        if (mProgressDialog == null) {
            ...
            dialog.setContentView(R.layout.sms_loading_layout);
